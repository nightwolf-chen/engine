//
//  platform_null_view_android.cpp
//  sources
//
...
namespace shell {
    ...
    class NullPlatformMessageResponseAndroid : public blink::PlatformMessageResponse {
        
        FRIEND_MAKE_REF_COUNTED(NullPlatformMessageResponseAndroid);
        
    public:
        void Complete(std::vector<uint8_t> data) override {
            fxl::RefPtr<NullPlatformMessageResponseAndroid> self(this);
...
//                std::shared_ptr<PlatformView> view = self->view_;
                if (!self->view_.get())
                    return;
                static_cast<PlatformNullViewAndroid*>(self->view_.get())
...
//                std::shared_ptr<PlatformView> view = self->view_;
    ...
    private:
        NullPlatformMessageResponseAndroid(int response_id,fxl::WeakPtr<shell::NullPlatformView> view)
        : response_id_(response_id), view_(view) {}
        
        int response_id_;
        fxl::WeakPtr<shell::NullPlatformView> view_;
    };
...
//    }
//
//    PlatformNullViewAndroid::PlatformNullViewAndroid()
//    : NullPlatformView(std::make_unique<Rasterizer *>()),
//    android_surface_(InitializePlatformSurface()) {}
    
    PlatformNullViewAndroid::~PlatformNullViewAndroid() = default;
    
    void PlatformNullViewAndroid::Attach() {
        CreateEngine();
    ...
    void PlatformNullViewAndroid::Detach() {
        ReleaseSurface();
    }
    
    void PlatformNullViewAndroid::SurfaceCreated(JNIEnv* env,
                                             jobject jsurface,
...
//        SetRasterizer(std::make_unique<NullRasterizer>(nullptr));
    ...
    void PlatformNullViewAndroid::SurfaceChanged(jint width, jint height) {
    ...
    void PlatformNullViewAndroid::UpdateThreadPriorities() {
    ...
    void PlatformNullViewAndroid::SurfaceDestroyed() {
        ReleaseSurface();
    }
    
    void PlatformNullViewAndroid::RunBundleAndSnapshot(JNIEnv* env, std::string bundle_path,
    ...
    void PlatformNullViewAndroid::RunBundleAndSource(std::string bundle_path,
                                                 std::string main,
                                                 std::string packages) {
        blink::Threads::UI()->PostTask([
    ...
    void PlatformNullViewAndroid::SetAssetBundlePathOnUI(std::string bundle_path) {
        blink::Threads::UI()->PostTask(
                                       [ engine = engine_->GetWeakPtr(), bundle_path = std::move(bundle_path) ] {
                                           if (engine)
    ...
    void PlatformNullViewAndroid::SetViewportMetrics(jfloat device_pixel_ratio,
                                                 jint physical_width,
    ...
    void PlatformNullViewAndroid::DispatchPlatformMessage(JNIEnv* env,
                                                      std::string name,
        ...
        if (response_id) {
            response = fxl::MakeRefCounted<NullPlatformMessageResponseAndroid>(
                                                                           response_id, GetWeakPtr());
//            response = fxl::MakeRefCounted<NullPlatformMessageResponseAndroid>();
//            response->setResponse_id(response_id);
//            response->setPlatformView(GetWeakPtr());
        }
    ...
    void PlatformNullViewAndroid::DispatchEmptyPlatformMessage(JNIEnv* env,
                                                           std::string name,
                                                           jint response_id) {
        fxl::RefPtr<blink::PlatformMessageResponse> response;
        if (response_id) {
...
//            response->setPlatformView(GetWeakPtr());
    ...
    void PlatformNullViewAndroid::DispatchPointerDataPacket(JNIEnv* env,
                                                        jobject buffer,
                                                        jint position) {
    ...
    void PlatformNullViewAndroid::InvokePlatformMessageResponseCallback(
                                                                    JNIEnv* env,
                                                                    jint response_id,
    ...
    void PlatformNullViewAndroid::InvokePlatformMessageEmptyResponseCallback(
                                                                         JNIEnv* env,
                                                                         jint response_id) {
        if (!response_id)
            return;
    ...
    void PlatformNullViewAndroid::HandlePlatformMessage(
    ...
    void PlatformNullViewAndroid::HandlePlatformMessageResponse(
                                                            int response_id,
    ...
    void PlatformNullViewAndroid::HandlePlatformMessageEmptyResponse(int response_id) {
        JNIEnv* env = fml::jni::AttachCurrentThread();
    ...
    void PlatformNullViewAndroid::DispatchSemanticsAction(JNIEnv* env,
                                                      jint id,
                                                      jint action,
                                                      jobject args,
                                                      jint args_position) {
...
//        SetRasterizer(std::make_unique<NullRasterizer>());
    ...
    void PlatformNullViewAndroid::RunFromSource(const std::string& assets_directory,
    ...
    void PlatformNullViewAndroid::SetAssetBundlePath(
    ...
    void PlatformNullViewAndroid::RegisterExternalTexture(
                                                      int64_t texture_id,
    ...
    void PlatformNullViewAndroid::MarkTextureFrameAvailable(int64_t texture_id) {
    ...
    fml::jni::ScopedJavaLocalRef<jobject> PlatformNullViewAndroid::GetBitmap(
                                                                         JNIEnv* env) {
    ...
    void PlatformNullViewAndroid::GetBitmapGpuTask(jobject* pixels_out,
                                               SkISize* size_out) {
